...
(
	...
	Constraint PK_Std_Exam Primary Key(NationalId,ExamId),
	Constraint FK_Std_Exam_Student Foreign Key (NationalId) references Student(NationalId),
	Constraint FK_Std_Exam_Exam Foreign Key (ExamId) references Exam(Exm_Id)
