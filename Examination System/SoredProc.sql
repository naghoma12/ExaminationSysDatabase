...
as
begin
declare @CourseCode nvarchar(6)= (Select Crs_Code from Exam where Exm_Id = @E_Id)
...
if exists(Select 1 from Student_Course where NationalId = @NationalId and Crs_Code = @CourseCode)
begin 
	update Student_Course
	set FinalResult = @CalcResult
	where NationalId = @NationalId and Crs_Code = @CourseCode
end
else
begin
...
values
(
	@NationalId , @CourseCode,@CalcResult
)
end
